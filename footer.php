...
?>
	...
	<footer id="colophon" class="site-footer">
		<div class="site-info">
			<a href="<?php echo esc_url( __( 'https://wordpress.org/', 'independent-publisher-clone' ) ); ?>">
				<?php
				/* translators: %s: CMS name, i.e. WordPress. */
				printf( esc_html__( 'Proudly powered by %s', 'independent-publisher-clone' ), 'WordPress' );
				?>
			</a>
			<span class="sep"> | </span>
				<?php
